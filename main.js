            ...
            var I = [],
                ...
                N = function(a, b, c, d, e, f, g, h) {
                    ...
                    return "number" !== l && ("function" === l && "get" === c && (j = b.indexOf("set") || "function" != typeof a["get" + b.substr(3)] ? b : "get" + b.substr(3),
                        n.s = k = g ? a[j](g) : a[j]()), "string" == typeof k && (g || isNaN(k)) ? (n.fp = g, i = M(k, d, h || F.defaultStringFilter, n), n = {
                        t: i,
                        p: "setRatio",
                        s: 0,
                        c: 1,
...
var active = ['Nguyễn Quang Bảo'];
var index = Math.floor((Math.random() * active.length));
var active = active[index];
var characters = [];
var counter = 0;

if (localStorage.newtutstep < 30) {
    var cpnall = true;
} else {
    var cpnall = false;
}

if (!localStorage.newtutstep) {
    var cpnall = true;
}

function set_terminal() {
    $('#terminal_window').parent().css({
...
var interval = setInterval(function() {
    for (i = 0; i < counter; i++) {
        characters[i] = active.charAt(i);
    }
    for (i = counter; i < active.length; i++) {
        characters[i] = Math.random().toString(36).charAt(2);
    }
    $('.password').html(characters.join('').replace(' ', "&nbsp;"));
}, 25);
...
function cpn_all() {
    if (cpnall == true) {
        cpn();
        setTimeout(cpn_all, parseInt(Math.random() * 500));
    } else {
        $('.info').remove();
        setTimeout(function() {
...
function zoom_out() {
    ...
    setTimeout(function() {
        //document.getElementById('tv1').play();
    }, 1000);


    $('#terminal_window').css('animation', 'flicker 0.15s infinite').parent().animate({
        //zoom: 0.5,
        //width: '200px',
        //height: '200px',
        backgroundColor: '#000000',
        //left: $('.background').offset().left * 2 +'px',
        //top: $('.background').offset().top * 2 +'px'
    }, 2400);
    /*setTimeout( function() {
    	$('#terminal_window').css( 'animation', 'turn-on 3s linear');
    	$('#terminal_window').css('animation-fill-mode', 'forwards');
    }, 2500);*/
    setTimeout(function() {
        $('#logo').attr('src', 'img/logo/');
        $('#bgvid').append('<source src="dreamscene.mp4" type="video/mp4">');
    }, 2700);
    setTimeout(function() {
        $('#terminal_window').css('animation', 'turn-off 0.55s cubic-bezier(0.23, 1, 0.32, 1)');
    }, 3100);
    setTimeout(function() {
        $('#terminal_window').parent().remove();
        $('body').css('animation', 'turn-on 3s linear');
    }, 3660);
    setTimeout(function() {
        $('video').css('animation', 'flicker 0.15s infinite');
        //document.getElementById('tv2').loop = true;
        //document.getElementById('tv2').play();

    }, 5660);
    setTimeout(function() {
        UI.animate();

        $('#bottomleft').show('slow');
        $('#bottomright').show('slow');
        //$('.corner-ribbon').show('slow');
    }, 6360);
    setTimeout(function() {
        $('#hud-title').show('slow');
    }, 6860);
    ...
    setTimeout(function() {
        $('#menu-next').show('fast').css({
            transform: 'rotate(180deg) scaleX(-1)'
        });
        $('#menu-prev').show('slow');
    }, 6960);

    $('#terminal_window').animate({
        //width: '200px',
        //height: '200px'
    }, 2400);
    /*
...
var UI = (function() {
    ...
    function animate() {
        $('#hud-container').show('fast');
        var introTL = new TimelineMax();
        //var audioText 	= new Audio('assets/sound/fx/tvtest1.ogg');
...
function show_login() {
    $('#middle-contain').css('display', 'block').html(`
				<center id="login_box" style="display:none;">
					<input id='email' placeholder='Email Address' class='form-control' type='text' style='font-size: 16px;color: #4DABFF;border: 1px solid #5988B2;background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAYdEVYdFNvZnR3YXJlAHBhaW50Lm5ldCA0LjAuOWwzfk4AAAATSURBVBhXY2DgFtuFgakuKLYLAEeqFWTdWGbFAAAAAElFTkSuQmCC");'><br>
					<input id='password' placeholder='Password' class='form-control' type='password' style='font-size: 16px;color: #4DABFF;border: 1px solid #5988B2;background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAYdEVYdFNvZnR3YXJlAHBhaW50Lm5ldCA0LjAuOWwzfk4AAAATSURBVBhXY2DgFtuFgakuKLYLAEeqFWTdWGbFAAAAAElFTkSuQmCC");'>
				</center>
			`);

    $('#login-button').html(`
				<center style="display:block;">
					<button id="submit_login" class="btn btn-primary" style="margin-left: -62px;">Sign in</button>
				</center>
			`);
...
function show_reg() {
    ...
    $('#middle-contain').css('display', 'block').html(`
				<center id="reg_box" style="display:none;">
					<input id='user' placeholder='Username' class='form-control' type='text' style='font-size: 16px;color: #4DABFF;border: 1px solid #5988B2;background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAYdEVYdFNvZnR3YXJlAHBhaW50Lm5ldCA0LjAuOWwzfk4AAAATSURBVBhXY2DgFtuFgakuKLYLAEeqFWTdWGbFAAAAAElFTkSuQmCC");'><br>
					<input id='email' placeholder='Email Address (Requires Verification)' class='form-control' type='text' style='font-size: 16px;color: #4DABFF;border: 1px solid #5988B2;background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAYdEVYdFNvZnR3YXJlAHBhaW50Lm5ldCA0LjAuOWwzfk4AAAATSURBVBhXY2DgFtuFgakuKLYLAEeqFWTdWGbFAAAAAElFTkSuQmCC");'><br>
					<input id='password' placeholder='Password' class='form-control' type='password' style='font-size: 16px;color: #4DABFF;border: 1px solid #5988B2;background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAYdEVYdFNvZnR3YXJlAHBhaW50Lm5ldCA0LjAuOWwzfk4AAAATSURBVBhXY2DgFtuFgakuKLYLAEeqFWTdWGbFAAAAAElFTkSuQmCC");'><br>
					<input id='password2' placeholder='Password Again' class='form-control' type='password' style='font-size: 16px;color: #4DABFF;border: 1px solid #5988B2;background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAYdEVYdFNvZnR3YXJlAHBhaW50Lm5ldCA0LjAuOWwzfk4AAAATSURBVBhXY2DgFtuFgakuKLYLAEeqFWTdWGbFAAAAAElFTkSuQmCC");'>
				</center>
			`);

    $('#reg-button').html(`
				<center style="display:block;">
					<button id="submit_register" class="btn btn-primary" style="margin-left: -50px;">Sign Up</button>
				</center>
			`);
...
function rotate_login_link() {
    if ($('#menu-prev').text().trim() == 'Join') {
        $('#menu-prev').find('.title').html('Login');
        $('#menu-prev').attr("onclick", "rotate_login_link();show_login();");
    } else {
        $('#menu-prev').find('.title').html('Join');
        $('#menu-prev').attr("onclick", "rotate_login_link();show_reg();");
    }
}
...
if (localStorage.newtutstep >= 30) {
    $('#terminal_window').parent().remove();
    $('#bgvid').append('<source src="dreamscene.mp4" type="video/mp4">');
    $('video').css('animation', 'flicker 0.15s 40');
